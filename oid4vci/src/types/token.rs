...
use crate::issuer::{AuthorizationCredential, AuthorizationDetail, ClientAssertion};
...
mod tests {
    ...
    use super::*;
    use crate::issuer::{AuthorizationCredential, AuthorizationDetailType, ClaimsDescription};
